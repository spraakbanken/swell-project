...
The fact that correction of the learner text is carried out as a separate step allows our system (Svala) to automatically construct a parallel corpus of this and the normalised text with alignments at the word level. Consequently, normalisation actually involves two subtasks: corrections of the learner text to obtain its normalisation, and changes of incorrect word alignments. An additional, independent advantage of the approach is that the resulting parallel corpus will be a highly valuable resource for development of automatic methods for identifying learner errors.
