...
Normalization in SVALA means editing of the original learner text in such a way that the sentences a) are correct with respect to orthography, morphology and syntax and b) are semantically coherent. The first point corresponds to the Minimal Target Hypothesis in the German learner corpus Falko ([Reznicek et al. 2012, page 42 ff.](https://www.linguistik.hu-berlin.de/de/institut/professuren/korpuslinguistik/forschung/falko)). However, the latter point goes further than the Minimal Target Hypothesis in allowing changes that affect meaning. A German example that highlights this difference (from [Boyd 2018, slide 7](https://sweclarin.se/sites/sweclarin.se/files/event_atachements/L2wsh_Boyd_slides.pdf)) is the Minimal Target Hypothesis "Rufst du deine Antwort an?" ("Do you call your answer?"), which is semantically anomalous. A semantically coherent target hypothesis, constituting the Extended Target Hypothesis in Falko, is "Rufst du mich wegen deiner Antwort an?" ("Will you call me to answer?"), which involves correction of semantics, pragmatics and stylistics. The reason that our target hypothesis goes beyond the Minimal Target Hypothesis in Falko is that SVALA only has a single level of target hypotheses. 
